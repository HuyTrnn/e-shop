...
const HeaderTop = () => {
    return (
      <div className="wrapper h-full px-7">
            ...
            <ul className="flex">
              ...
              >
                <button>
                  ...
                  {/* {totalQuantity > 0 && (
                    <span className="bg-red-500 text-primary-50 text-xs rounded-full w-5 h-5 flex items-center justify-center ml-1 absolute bg-hoverColor bottom-0 right-[18px]">
                      {totalQuantity}
                    </span>
                  )} */}
                </button>
